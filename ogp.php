...
?>
<?php if (is_home()) : ?>
	<meta property="og:title" content="<?php bloginfo('name'); ?><?php if (! get_bloginfo('description') == null) {
																		echo $sepalater;
...
<?php elseif (is_singular()): ?>
	...
	<?php elseif (! empty($use_excerpt)) : ?>
		<meta property="og:description" content="<?php echo $use_excerpt; ?>">
	<?php else: ?>
		<meta property="og:description" content="<?php echo jin_auto_desc_func_custom(); ?>">
	<?php endif; ?>
<?php elseif (is_404()) : ?>
...
<?php elseif (is_singular()): ?>
	<?php if (has_post_thumbnail()) : ?>
		...
		$image    = get_post_meta($post->ID, '_jin_ogp_image_url', true);
		$last_id    = get_post_meta($post->ID, '_jin_last_featured_id', true);
